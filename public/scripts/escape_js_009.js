  ...
  // };
    ...
    function sendConverse(inputText) {
      ...
      if (inputText.toUpperCase() == "DETECT") {
        ...
        vdo1.setAttribute("width", "640");
        vdo1.setAttribute("height", "440");
        ...
        dv.appendChild(vdo1);
        // document.getElementById("tcon").appendChild(dv);
        document.getElementById("usrImg").appendChild(dv);

        var vdo1 = document.createElement("video");
        vdo1.setAttribute("width", "640");
        vdo1.setAttribute("height", "auto");
        vdo1.setAttribute("style", "position: relative;");
        vdo1.setAttribute("autoplay", "autoplay");
        ...
        can1.setAttribute("height", "440");
        can1.setAttribute("width", "640");
        ...
        async function detectObjects(video1, modelcc, canvas11, canvas12) {
          ...
          if (video1.readyState === video1.HAVE_ENOUGH_DATA && modelcc && model) {
            ...
            announcementText = "Fire detected. Location is basement storage area. Source Camera number is 1. OnDuty Fire Officers to act as per the steps defined."
            for (let i = 0; i < maxPredictions; i++) {
                ...
                if (prediction12[i].className == 'Flame_1' && prediction12[i].probability.toFixed(2) > 0.90 ){
                  ...
                  context2.fillText(prediction12[i].probability.toFixed(2), 15, 25);
    ...
    function shouldAnnounceDetection() {
      ...
      if (Shp == 'text' ) {
        ...
        const apiKey = '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'; 
        ...
        console.log('prompt>>'+userMessage)
          ...
          fetch('https://api.openai.com/v1/chat/completions', {
              ...
              body: JSON.stringify({
                  ...
                  "messages": [
                      {"role": "system", "content": "As an expert Fire Instructor explain the topic in detailed at times checking the students interest by asking random questions" }, //You are a poetic assistant, skilled in explaining complex programming concepts with creative flair.
          ...
          .then(response => {
            ...
            waitImg.src="";
            let array = response.choices[0].message.content; //.split("\n").filter(line => line.trim() !== '');
            const searchValue = 3;
            ...
            array = response.choices[0].message.content.replace(/\\n/g, '\n').replace(/\\/g, '').replace(/^\n\n/, '');  //.split("\n").filter(line => line.trim() !== '');
    ...
    window
        .addEventListener(
            ...
            function() {
              ...
              historyArea.value += "me>> "+ "Welcome to the AI World!!" + "\n";
              historyArea.scrollTop = historyArea.scrollHeight; 
            ...
            //   cmsImg.src="https://responsivevoice.org/wp-content/uploads/2020/01/parrot-flight.png"
              ...
              // sendConverse("Jargon of the day");
            //   uvid.play();
              // setTimeout('loadJson("' + BASE_CMS_URL + '/content/json/bots.json")', 100);
...
*/
    ...
    function playNextImage(count) { 
      ...
      if (flg) {
        ...
        playButton.id = 'cb1'+bid+count.toString();;
        playButton.textContent = 'Pause';
